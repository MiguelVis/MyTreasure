<?php
	...
	// Dependencies
	require_once(dirname(__FILE__) . '/../../actions/get_genres.php');
	...
	$table->setGetParams(array('action' => 'genres'));
	
	// Get page length
	$page_length = $table->getPageLength();
	
	// Read records
	$records = get_genres($table->getPage(), $page_length);
...
<header class="w3-container">
	<h5><b><i class="fa fa-user-secret fa-fw"></i> <?php say('Genres'); ?></b></h5>
...
<div id="modal_info" class="w3-modal">
	<div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
		<header class="w3-container w3-teal"> 
			...
			<h2><?php say('GenreInfo'); ?> &nbsp;|&nbsp; <span id="modal_info_id"></span></h2>
		</header>
  ...
  <div id="modal_add" class="w3-modal">
    <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
      <header class="w3-container w3-teal"> 
        ...
        <h2><?php say('AddGenre'); ?></h2>
      </header>
	  
      <form class="w3-container" method="post" action="index.php?action=add_genre">
        <div class="w3-section">
			<label><b><?php say('Name'); ?></b></label>
			<input class="w3-input w3-margin-bottom w3-border" type="text" placeholder="" id="modal_add_name" name="genre_name" required>
		  <hr>
  ...
  <div id="modal_edit" class="w3-modal">
    <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
      <header class="w3-container w3-teal"> 
        ...
        <h2><?php say('EditGenre'); ?> &nbsp;|&nbsp; <span id="modal_edit_id"></span></h2>
      </header>
	  
      <form class="w3-container" method="post" action="index.php?action=edit_genre">
        <div class="w3-section">
			<input class="" type="hidden" id="modal_edit_id_hidden" name="genre_id" value="">
			<label><b><?php say('Name'); ?></b></label>
			<input class="w3-input w3-margin-bottom w3-border" type="text" placeholder="" id="modal_edit_name" name="genre_name">
			<hr>
  ...
  <div id="modal_delete" class="w3-modal">
    <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
      <header class="w3-container w3-teal"> 
        ...
        <h2><?php say('DeleteGenre'); ?> &nbsp;|&nbsp; <span id="modal_delete_id"></span></h2>
      </header>
	  
      <form class="w3-container" method="post" action="index.php?action=delete_genre">
        <div class="w3-section">
			<input class="" type="hidden" id="modal_delete_id_hidden" name="genre_id" value="">
			<p>
				<?php echo str_replace('*','<b><span id="modal_delete_show">?</span></b>', tr('AskDeleteGenre')); ?>
			</p> 
			<hr>
