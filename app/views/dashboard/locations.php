<?php
	...
	// Dependencies
	require_once(dirname(__FILE__) . '/../../actions/get_locations.php');
	...
	$table->setGetParams(array('action' => 'locations'));
	
	// Get page length
	$page_length = $table->getPageLength();
	
	// Read records
	$records = get_locations($table->getPage(), $page_length);
...
<header class="w3-container">
	<h5><b><i class="fa fa-map-marker fa-fw"></i> <?php say('Locations'); ?></b></h5>
...
<div id="modal_info" class="w3-modal">
	<div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
		<header class="w3-container w3-teal"> 
			...
			<h2><?php say('LocationInfo'); ?> &nbsp;|&nbsp; <span id="modal_info_id"></span></h2>
		</header>
  ...
  <div id="modal_add" class="w3-modal">
    <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
      <header class="w3-container w3-teal"> 
        ...
        <h2><?php say('AddLocation'); ?></h2>
      </header>
	  
      <form class="w3-container" method="post" action="index.php?action=add_location">
        <div class="w3-section">
			<label><b><?php say('Name'); ?></b></label>
			<input class="w3-input w3-margin-bottom w3-border" type="text" placeholder="" id="modal_add_name" name="location_name" required>
		  <hr>
  ...
  <div id="modal_edit" class="w3-modal">
    <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
      <header class="w3-container w3-teal"> 
        ...
        <h2><?php say('EditLocation'); ?> &nbsp;|&nbsp; <span id="modal_edit_id"></span></h2>
      </header>
	  
      <form class="w3-container" method="post" action="index.php?action=edit_location">
        <div class="w3-section">
			<input class="" type="hidden" id="modal_edit_id_hidden" name="location_id" value="">
			<label><b><?php say('Name'); ?></b></label>
			<input class="w3-input w3-margin-bottom w3-border" type="text" placeholder="" id="modal_edit_name" name="location_name">
			<hr>
  ...
  <div id="modal_delete" class="w3-modal">
    <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
      <header class="w3-container w3-teal"> 
        ...
        <h2><?php say('DeleteLocation'); ?> &nbsp;|&nbsp; <span id="modal_delete_id"></span></h2>
      </header>
	  
      <form class="w3-container" method="post" action="index.php?action=delete_location">
        <div class="w3-section">
			<input class="" type="hidden" id="modal_delete_id_hidden" name="location_id" value="">
			<p>
				<?php echo str_replace('*','<b><span id="modal_delete_show">?</span></b>', tr('AskDeleteLocation')); ?>
			</p> 
			<hr>
